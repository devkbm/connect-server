/* 사용자 */
INSERT INTO com.cmuser(user_id, password, user_name, non_expired_yn, non_locked_yn, enabled_yn, pass_non_expried_yn, sys_dt, sys_user, upd_dt, upd_user)
...
/* 메뉴 */
INSERT INTO com.cmmenu(menu_code, menu_group_code, program_code, p_menu_code, sys_dt, sys_user, upd_dt, upd_user, menu_name, seq, `level`)
...
/* 권한 */
INSERT INTO com.cmauthority(authority_name, description, sys_dt, sys_user, upd_dt, upd_user)
...
/* 사용자_권한 */
INSERT INTO com.cmuserauthority(user_id, authority_name)
VALUES('1', 'ROLE_USER');

/* 사용자_메뉴그룹 */
INSERT INTO com.cmusermenugroup(user_id, menu_group_code)
VALUES('1', 'COM');
INSERT INTO com.cmusermenugroup(user_id, menu_group_code)
VALUES('1', 'GRP');
